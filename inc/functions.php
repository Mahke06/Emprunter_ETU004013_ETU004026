...
function getAllObjets($id_categorie = 0) {
    $sql = "SELECT o.id_objet, o.nom_objet, c.nom_categorie, e.date_retour FROM Emprunter_objet o JOIN 
    Emprunter_categorie c ON o.id_categorie = c.id_categorie JOIN Emprunter_emprunt e 
