...
<section class="container py-4">
  <form method="get" class="mb-4">
    ...
    <form action="traitmentempreint.php">
    ...
    <a href="ficheobjet.php?id=<?php echo $objet['id_objet']; ?>" style="text-decoration:none; color:inherit;">
        ...
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <?php if (!$objet['date_retour']) { ?>
                        <button class="btn btn-secondary mt-2">Emprunte</button>
                    <?php } else { ?>
                        <form action="traitmentempreint.php" method="post" style="margin-top: 10px;">
                            <input type="hidden" name="id_objet" value="<?php echo $objet['id_objet']; ?>">
                            <button type="submit" class="btn btn-success w-100">Emprunter</button>
                        </form>
            <?php } ?>
        </div>
        </article>
